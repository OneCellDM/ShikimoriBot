...
namespace ShikimoriSharp.Bases
{
    public abstract class ApiBase
    {
        ...
        protected ApiBase(ShikimoriSharp.Enums.Version version, ApiClient apiClient)
        {
            Version = version;
            _apiClient = apiClient;
        }

        public ShikimoriSharp.Enums.Version Version { get; }
        ...
        private string GetThing()
        {
            ...
            {
                ShikimoriSharp.Enums.Version.v1 => "",
                _ => Version + "/"
            };
        }
